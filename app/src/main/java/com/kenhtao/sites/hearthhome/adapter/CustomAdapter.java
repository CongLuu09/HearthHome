...
public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (item.type == TYPE_GROUP) {
            ...
            // ✅ Load icon từ drawable local thay vì URL
            if (sound.getImageResId() != -1) {
                childHolder.ivIcon.setImageResource(sound.getImageResId());
            } else {
                childHolder.ivIcon.setImageResource(R.drawable.sound_airplane); // fallback
            }
    ...
    static class ChildViewHolder extends RecyclerView.ViewHolder {
        ...
        ChildViewHolder(@NonNull View itemView) {
            ...
            ivIcon = itemView.findViewById(R.id.imgSound);
